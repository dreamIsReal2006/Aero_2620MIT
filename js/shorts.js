(() => {
    ...
    function renderCurrentVideo() {
        ...
        const avatar = window.AeroAvatar?.markup({ ...author, avatar_url: avatarUrl }, 'short-author-avatar') || (avatarUrl ? `<img src="${escapeText(mediaUrl(avatarUrl))}" alt="">` : escapeText((author.username || 'U').charAt(0).toUpperCase()));
